    ...
    return (
        <div className="absolute mt-40 z-1 h-[80vh] md:w-[100vw] xl:w-[90vw] 2xl:w-[60vw] rounded-[1.5rem] grid grid-cols-1 md:grid-cols-2  place-items-center ">
            <div className='h-[80vh] w-[90vw] md:w-[40vw] 2xl:w-[25vw] rounded-[1.5rem] grid grid-cols-1 gap-3 place-content-between 2xl:place-items-center '>
                <div className='border-1 border-zinc-600 bg-linear-to-bl from-blue-600 to-pink-500 p-1 rounded-[1.7rem]'>
                    <div className='h-[45vh] w-[90vw] md:w-[40vw] 2xl:w-[25vw] border border-white/20 rounded-[1.5rem] bg-black backdrop-blur-sm flex flex-col items-center justify-between text-4xl p-2'>
                ...
                <div className='border-1 border-zinc-600 bg-linear-to-bl from-blue-600 to-pink-500 p-1 rounded-[1.7rem]'>
                    <div className='h-[30vh] w-[90vw] md:w-[40vw] 2xl:w-[25vw] border border-white/20 rounded-[1.5rem] bg-black backdrop-blur-sm flex flex-col items-center justify-center text-2xl'>
            ...
            <div className='h-[80vh] w-[90vw] md:w-[40vw] 2xl:w-[25vw] rounded-[1.5rem] grid grid-col-1 gap-3 place-content-between mt-10 md:mt-0 '>
                <div className='border-1 border-zinc-600 bg-linear-to-bl from-blue-600 to-pink-500 p-1 rounded-[1.7rem]'>
                    <div className='h-[45vh] w-[90vw] md:w-[40vw] 2xl:w-[25vw] border border-white/20 rounded-[1.5rem] bg-black backdrop-blur-sm flex flex-col items-center justify-center text-4xl'>
                ...
                <div className='border-1 border-zinc-600 bg-linear-to-bl from-blue-600 to-pink-500 p-1 rounded-[1.7rem]'>
                    <div className='h-[30vh] w-[90vw] md:w-[40vw] 2xl:w-[25vw] p-5 border border-white/20 rounded-[1.5rem] bg-black backdrop-blur-sm flex flex-col items-center'>
