...
export default function transaction() {
    ...
    return (
        <div className="absolute mt-40 z-1 h-[70vh] lg:h-[70vh] 2xl:h-[75vh] w-[90vw] lg:w-[80vw] flex flex-col justify-between items-center rounded-[1rem] border border-white/20  bg-white/4 backdrop-blur-sm">
